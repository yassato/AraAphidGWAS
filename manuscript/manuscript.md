...
# Abstract  
Plant size, height, and other architectural traits, collectively called 'plant apparency', determine a plant's visibility and consequent probability of being colonized by herbivores.
...
This GWAS of aphid abundance detected a relatively rare but significant variant on the third chromosome of *A. thaliana*, which was also partly associated with the presence or absence of inflorescence. 
...
For example, plant size, height, and other architectural traits often shape plants' visibility for herbivores [@zverev2017ontogenetic; @higuchi2019leaf].
These sets of visible traits, collectively called plant apparency [@feeny1976plant], change across ontogeny from the vegetative to the reproductive stage [@barton2017future] and thereby affect the probability of being harbored by herbivores [@kawagoe2010escape; @marquis2021escape].
...
Of the diverse insect herbivores, aphids are known to be the major herbivores occurring across the natural distribution range of *A. thaliana* [@zust2012natural]. 
...
Since 38% of plants initiated bolting in the field (see Results), longer experiments were hard due to the short life span of flowered *A. thaliana*.  
...
A gel electrophoresis was performed using a 1\% agarose with 120 V for 60 min. The PCR products were finally visualized by a UV trans-illuminator system.  
...
This top-scoring SNP was also associated with the bolting to a non-significant but strong extent (-log~10~($p$)=5.26; Fig. [1](#fig:ManPlot){reference-type="ref"}c; Fig. [S4](#fig:qqplot){reference-type="ref"}b).
When we adjusted the effects of bolting on aphid abundance (Fig. [1](#fig:ManPlot){reference-type="ref"}d; Fig. [S4](#fig:qqplot){reference-type="ref"}c), the association of Chr3-4579292 to the aphid abundance became weaker and less than the Bonferroni threshold, but remained at -log~10~($p$)=6.40.
The result suggests the partial contribution of the bolting to shaping the significant association between Chr3-4579292 SNP and aphid abundance.
...
Bolting and flowering time represent similar traits, and indeed we found the same broad peak on the top of the fourth chromosome as reported by previous GWAS of flowering time [@aranzana_genome-wide_2005].
...
Five out of the 196 accessions carried a rare variant increasing aphid abundance, while the other accessions have a major variant (Fig. [S5](#fig:database){reference-type="ref"}a).
...
This additional evidence suggests that rare accessions carrying more aphids have consistent patterns near the Chr3-4579292.
...
To examine visible phenotypes of the ribosomal gene mutant (AT3G13882), we compared the growth and flowering time of this mutant with the Col-0 wild type. 
...
We observed a reduced number of aphids on the AT3G13882 mutant compared to the wild type at 7, 10, and 14 days after the release of aphids ($F_{1,9}=19.3, p=0.0017$ at 7 days; Fig. [2](#fig:mutant){reference-type="ref"}d: see also Fig. [S6](#fig:aphid_stat){reference-type="ref"} for results at 10 and 14 days; Table S5), suggesting that the delayed growth of the host negatively affected aphid colony establishment.
...
When the plant size was offset, the number of aphids differed less significantly between the wild type and mutant ($F_{1,9}=6.9, p=0.027$ at 7 days: see also Table S5). 
When the flowering time was offset, the number of aphids differed more significantly between the wild type and mutant ($F_{1,9}=40.78, p<0.001$ at 7 days: see also Table S5).
These additional analyses suggested that delayed growth rather than delayed flowering contributed more to the unsuccessful establishment of aphid colonies, though these two phenotypes were highly corrected each other (Pearson's correction coefficient, $r=-0.913, p<10^{-7}$).  

# Discussion
Guided by the field GWAS of aphid abundance, we found that a mutant plant exhibited slower growth and thereby harbored fewer aphids in _A. thaliana_.
...
Because transgenic approaches may not be effective to identify mutation sites affecting quantitative traits, further experimental tests, such as quantitative complementation and genome editing [@tsuchimatsu2020adaptive; @kakui2022pollen], will be needed to study natural causal variants that alter aphid abundance through delayed growth.  

The discovery of flowering-associated loci is sometimes of main interest in GWAS, but this may also conceal direct genetic associations between a focal locus and other complex traits of interest [@hori2012variation; @onogi2016uncovering]. 
Our GWAS of aphid abundance unexpectedly led us to detect a significant variant that was also partially associated with the bolting.
The substantial contributions of plant apparency to aphid abundance were detected by correcting the plant size and flowering time as confounding factors.
...
Such time-varying effects of plant traits on aphid colonization are difficult to evaluate using the short-lived annual *A. thaliana*.
Further studies on long-lived plants in addition to the identification of natural causal variants would be needed to verify the long-term impacts of a single plant gene on herbivory.  
