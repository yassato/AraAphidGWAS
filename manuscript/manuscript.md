...
Yet, little is known about key genes allowing plants to escape from herbivores. 
...
Genome-wide association study (GWAS) provides a hypothesis-free approach to dissecting the genetic architecture of ecologically important traits [@anderson2011ecological; @santure2018wild] and identifying novel genes from natural phenotypic variation [@fujii2019stigmatic; @tsuchimatsu2020adaptive]. 
...
This fact emphasizes the importance of *in natura* study of functional genes [@shimizu2011plant; @kudoh2016molecular; @yamasaki2017genomics; @zaidem2019evolutionar; @stockenhuber2021uv].
...
Excluding two trichome mutants and an ungenotyped accession, we used almost the same set of 196 *A. thaliana* accessions as a previous study [@sato2021neighbor]. 
...
Following the instruction [@o2015user], we confirmed the insertion site by polymerase chain reaction (PCR) amplification and Sanger sequencing; and gene expression levels by Semi-quantitative reverse transcription and PCR (sqRT-PCR) (see captions of Fig. [S1](#fig:tDNA){reference-type="ref"} and Fig. [S2](#fig:sqRT_PCR){reference-type="ref"} for details). 
We finally obtained one confirmed line of the SALK_039481 (NASC Accession ID: N670586) for AT3G13882, because some lines failed to germinate or to confirm an insertion site. 
This confirmed line had an insertion on an exon of one of two splice variants (Fig. [S1](#fig:tDNA){reference-type="ref"}) and exhibited lower expression level than the Col-0 wild type (Fig. [S2](#fig:sqRT_PCR){reference-type="ref"}).  
...
Winged and wingless aphids colonized vegetative plants until the first monitoring after the transplant, but many of these aphids did not establish a colony in subsequent monitoring (the days between 07 and 10 July 2018: Fig. [S5](#fig:aphid_day){reference-type="ref"}). 
...
The aphid abundance had high heritability among the plant accessions ($h^2 = 0.7$), indicating that this trait was likely under genetic control. 
Regarding the aphid abundance, our mapping detected a significant SNP in an intergenic region above the genome-wide Bonferroni threshold (chr3-4579292, $p<10^{-8}$,  MAF=0.026: Fig. [1](#fig:ManPlot){reference-type="ref"}; see also Fig. [S4](#fig:qqplot){reference-type="ref"} for quantile-quantile plots). 
...
After 20 days of growth, the AT3G13882 mutant had a significantly smaller size than the wild type ($t=6.33, p<0.001$ by Gaussian GLMs: Fig. [2](#fig:mutant){reference-type="ref"}A,B), showing the delayed growth of AT3G13882 mutant. 
...
Then, to examine the colony establishment after aphid colonization, we released wingless individuals of *Lipaphis erysimi* on vegetative plants of the ribosomal gene mutant (AT3G13882) and the wild type. 
One week after the release, aphids were more likely to failed colonizing the AT3G13882 mutant than on the wild type ($Z=4.41, p<0.001$ by Poisson GLMs; Fig. [2](#fig:mutant){reference-type="ref"}D), showing adversarial effects of delayed growth on the aphid colony establishment.  
...
This result agree with the notion that gene functions revealed under laboratory condition may not always reflect those under field environments [@shimizu2011plant; @kudoh2016molecular]. 
