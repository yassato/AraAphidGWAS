...
This additional evidence suggested that the association between the aphid abundance and rare alleles at Chr3-4579292 was not random.
...
These additional analyses indicated that delayed growth rather than delayed flowering contributed more to the unsuccessful establishment of aphid colonies, though these two phenotypes were highly corrected each other (Pearson's correction coefficient, $r=-0.913, p<10^{-7}$).  
...
![Figure S5. Phenotype values (a) and amino acid sequences (b) focusing on the rare variant at Chr3-4579292. (a) The aphid abundance i.e., log(no. of aphids) between major and rare SNP alleles at Chr3-4579292. Bars indicate medians of the aphid abundance. (b) A comparison of amino acid sequences near Chr3-4579292 among accessions carrying rare or major alleles. Four accessions above Col-0 sequence show those of the rare allele (highlighted by red squares), while accessions below the Col-0 show those of the lowest phenotypic values (highlighted by blue squares). The panel (a) and (b) is depicted using the GWA-portal (<https://gwas.gmi.oeaw.ac.at/>) and 1001 Genome Browser (<http://signal.salk.edu/atg1001/3.0/gebrowser.php>), respectively.](../figures/database_snapshot.png){#fig:database}
