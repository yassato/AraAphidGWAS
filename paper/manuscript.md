...
---
# Genome-wide association study highlights escape by delayed growth from aphid herbivory on field-grown *Arabidopsis thaliana*
...
Two small unknown genes (AT3G13882 and AT3G13898) as well as *MYB26* were located nearby the significant SNP (chr3-4579292). Thus, we cultivated single-gene mutants of these three genes to examine their visible phenotypes. **[Describe the results of growth and flowering time].**


### Aphid attachment experiments
To test whether the delayed growth could prevent aphid colonization, we then released *Lipaphis erysimi*, one of the two aphid species observed in the field, on mutant plants. **[Describe the results of aphid numbers].**
